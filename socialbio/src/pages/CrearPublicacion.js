        ...
        <div className='container-fluid'>
          <div className="row">
            ...
            <div className='col-xl-7 col-md-10 col-12 '>
                <div className='row'>
                <Link to='/Home'><button className='btnVerdeInvertido text-center m-2' onClick={this.props.handleClose}><FontAwesomeIcon icon={faArrowLeft}/> Volver</button></Link>
                </div>
                {(() => {
                if (this.state.alert){
                    return (
                ...
                <h5 className="titulosPublicacion m-2" >Seleccione que tipo de publicación quieres crear</h5>
                </div>
